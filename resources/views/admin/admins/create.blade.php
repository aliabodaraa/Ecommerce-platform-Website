@extends('layouts.app', ['title' => __('Admain_Managment')])

@section('content')
    @include('admin.users.partials.header', [
        'title' => __('New Admin') . ' ',
        'description' => __('Hi '.auth()->user()->name .' can create a new admin'),
        'class' => 'col-lg-12'
    ])
            ...
            <div class="col-xl-8 order-xl-1">
                ...
                <form role="form" method="POST" action="{{ route('admins.store') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-5">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fa fa-check-circle" aria-hidden="true"></i></i></span>
                                    </div>
