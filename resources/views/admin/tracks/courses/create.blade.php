...
@section('content')
    @include('admin.users.partials.header', [
        'title' => __('New Course innside track') . ' ',
        'description' => __('Hi '.auth()->user()->name .'You can Create Course inside Track'),
        'class' => 'col-lg-12'
    ])
...
<h1>Createe </h1>
                <form role="form" method="POST" action="{{ route('track.courses.store',$track) }}" enctype="multipart/form-data">
                            @csrf
{{-- Title --}}
