@extends('layouts.app', ['title' => __('quiz_Create')])

@section('content')
    @include('admin.users.partials.header', [
        'title' => __('New quiz') . ' ',
        'description' => __('Hi '.auth()->user()->name .' can create a new quiz'),
        'class' => 'col-lg-12'
    ])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="mb-0"><i class="fa fa-quiz" aria-hidden="true"></i> {{ __('Create quiz') }}</h3>
                        </div>
                    </div>
